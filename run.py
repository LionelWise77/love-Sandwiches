...
def update_surplus_worksheet(data):
    """
    update surplus worksheet, add a new row with the new data provided
    """
...
def calculate_surplus_data(sales_row):
    ...
    the surplus is decide as the sales figure subtracted from the stock:
    - Positive suprplus indicate waste.
